  ...
  return (
    <div className="p-10 overflow-y-auto h-full bg-canvas">
      ...
      <div className="mt-6 p-5 bg-marker/15 border-2 border-dashed border-border-pencil/40 rounded-xl text-sm text-slate-600">
        ...
        Bảng trên là benchmark offline chạy Ollama trên GPU server. Web Playground dùng Gemini (free tier, mặc định gemini-flash-latest) để sinh câu trả lời và BM25/Jina để truy xuất, minh họa pipeline tương tác; số liệu runtime không được xem là benchmark tương đương.
      </div>
    </div>
  );
}
